...
module.exports = (sequelize, DataTypes, models) => {
    ...
    const rlsAfterRestore = async function (data, transaction) {
        ...
        await RlsCoreService.addParentPermissionsNested(parent, id, 'Metadata', {}, transaction).catch(console.error);
        return data;
    }
