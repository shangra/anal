...
import { FilterIcon } from 'components/MetadataForms/Buttons/Filter/Icon/filter.icon';
...
export class Filter extends Component {
    ...
    async getFieldsByObject(fromObject) {
        if(fromObject) {
            ...
            const showFields = [...res.registryFields, ...res.registryTableFields].filter((el) => el.show === true);
            this.setState( {fields: showFields} )    
        }
    }
