import { ChangeEvent, Component, MouseEvent, type ReactNode } from 'react';
...
import styles from './FullTextEditor.module.css';
...
export class FullTextEditorContent extends Component<FullTextEditorProps, FullTextEditorState> {
...
export class FullTextEditor extends Component<FullTextEditorProps> {
    render(): ReactNode {
        ...
        return (
            ...
            >
                <FullTextEditorContent {...this.props} />
            </ErrorBoundary>
        );
    }
}
