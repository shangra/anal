const ServiceClass = require('../services/InfoserviceMatrixGuide.service');
const Service = new ServiceClass();

class InfoservicesMatrixGuideController {
...
module.exports = InfoservicesMatrixGuideController;
