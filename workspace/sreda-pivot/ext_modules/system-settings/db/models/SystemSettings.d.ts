...
type TSystemSettingsCreationAttributes =
    import('./type/SystemSettings').TSystemSettingsCreationAttributes;
 ...
 */
declare class SystemSettings extends DB<
    import('./type/SystemSettings').TSystemSettingsAttributes,
    import('./type/SystemSettings').TSystemSettingsCreationAttributes
> {
