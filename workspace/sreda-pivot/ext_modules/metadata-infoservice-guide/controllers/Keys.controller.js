...
class KeysController {
  /**
     ...
     * /keys/metadata:
     *   get:
     *     summary: Получение всех метаданных ключей
     *     tags: [Keys]
     *     security:
     *       - Adminpanel: []
     *       - MetadataAdmin: []
  ...
  /**
     ...
     * /keys/metadata/{id}:
     *   get:
     *     summary: Получение метаданных ключа по ID
     *     tags: [Keys]
     *     security:
     *       - Adminpanel: []
     *       - MetadataAdmin: []
     *     parameters:
     *       - name: id
     *         description: ID метаданных ключа
     *         in: path
     *         required: true
     *         type: string
     *     responses:
  ...
  /**
     ...
     * /keys/metadata:
     *   post:
     *     summary: Создание новых метаданных ключа
     *     tags: [Keys]
     *     security:
     *       - Adminpanel: []
     *       - MetadataAdmin: []
  ...
  /**
     ...
     * /keys/metadata/{id}:
     *   put:
     *     summary: Обновление метаданных ключа
     *     tags: [Keys]
     *     security:
     *       - Adminpanel: []
     *       - MetadataAdmin: []
  ...
  /**
     ...
     * /keys/metadata/{id}:
     *   delete:
     *     summary: Удаление метаданных ключа
     *     tags: [Keys]
     *     security:
     *       - Adminpanel: []
     *       - MetadataAdmin: []
