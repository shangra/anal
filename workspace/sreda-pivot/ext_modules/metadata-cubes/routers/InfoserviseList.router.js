...
const Controller = require('../controllers/InfoserviseList.controller');
...
router.route('/:id').get(Controller.metadataItem);
router.route('/:id').put(Controller.updateMetadata);
router.route('/:id').delete(Controller.deleteMetadata);
