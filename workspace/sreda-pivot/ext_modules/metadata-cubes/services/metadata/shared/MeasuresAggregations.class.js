...
class MeasuresAggregationsClass extends LevelClass {
    constructor(props) {
        super(props);
    ...
    parse(item) {
        const field = item.manifest.settings;

        return {
            aggrFunc: field.aggrFunc,
            onoff: field.onoff,
            onoffFilter: field.onoffFilter ?? false,
        };
    }
}

module.exports = MeasuresAggregationsClass;
