class Extensions {
    ...
    static buildFunctionParams(paramNames, args, instance) {
        ...
        // старые хуки (Processing.class, Overloads.class) читают functionParams._args - лучше дать обратную совместимость
        Object.defineProperty(functionParams, '_args', {
            value: args,
            enumerable: false,
        });
    ...
    static createWrapper(prototype, methodName) {
        return async function (...args) {
            ...
            if (decorated.trace && decorated.result !== undefined) {
                ...
                Extensions.log('source skipped by inner', methodName);
            } else {
