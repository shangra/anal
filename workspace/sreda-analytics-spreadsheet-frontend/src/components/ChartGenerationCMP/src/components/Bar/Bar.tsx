...
import { Bar as BarElement, BarChart, CartesianGrid, Legend, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts';
...
export const Bar: FC<BarProps> = (props) => {
    ...
    const computedLineMeta = useMemo(() => getLineComputedDataLineMeta(data, meta, { fill: true }), [data, meta]);
