...
import { CartesianGrid, Legend, Line as LineElement, LineChart, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts';
...
export const Line: FC<LineProps> = (props) => {
    ...
    const computedLineMeta = useMemo(() => getLineComputedDataLineMeta(data, meta, { stroke: true }), [data, meta]);
